...
โครงงานนี้เป็นการพัฒนาโมเดล Machine Learning เพื่อจำแนกระดับพฤติกรรมการเสพติดโซเชียลมีเดียของนักเรียนและนักศึกษา  
โดยใช้ข้อมูลเชิงพฤติกรรม และเทคนิคการเรียนรู้แบบมีผู้สอน (Supervised Learning) เพื่อช่วยวิเคราะห์และทำความเข้าใจปัจจัยที่ส่งผลต่อการใช้งานโซเชียลมีเดียอย่างไม่เหมาะสม
